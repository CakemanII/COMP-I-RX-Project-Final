...
class Scene10 extends Scene {
    ...
    protected sceneName: string = "Sea Walls in Tampa Bay"
    ...
    private dialogueSequence(overlay_id: string) {
        ...
        if (!this.sceneObjectives[`dialogue-${dialogueNumber}-completed`]) {
            ...
            switch (dialogueNumber) {
                case 1:
                    image = "../media/scene10/water_both_sides.png";
                    break;
                case 2:
                    image = "../media/scene10/inland.jpg";
                    break;
                case 3:
                    image = "../media/scene10/living.png";
                    break;
                case 4:
                    image = "../media/scene10/old_sea_wall.png";
                    break;
                default:
