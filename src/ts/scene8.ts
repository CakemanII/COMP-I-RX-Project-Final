...
class Scene8 extends Scene {
    ...
    protected sceneName: string = "Nature Barriers in Tampa Bay"
    ...
    private dialogueSequence(overlay_id: string) {
        ...
        if (!this.sceneObjectives[`dialogue-${dialogueNumber}-completed`]) {
            ...
            switch (dialogueNumber) {
                case 1:
                    image = "../media/scene8/beach_rock_barrier.png";
                    break;
                case 2:
                    image = "../media/scene8/mangroves.png";
                    break;
                case 3:
                    image = "../media/scene8/vegetated-swale.jpg";
                    break;
                case 4:
                    image = "../media/scene8/salt_marshes.png";
                    break;
                default:
